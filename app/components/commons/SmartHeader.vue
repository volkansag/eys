...
import ScheduleRibbonMenu from '~/components/schedule/ScheduleRibbonMenu.vue'
...
<template>
  <Transition name="smart-header">
    <header 
      v-smart-header 
      v-show="!state.unpinned" 
      :class="['site-header', {
...
.smart-header-enter-active,
.smart-header-leave-active
  transition: transform 300ms ease
  will-change: transform

.smart-header-enter-from,
.smart-header-leave-to
  transform: translateY(-100%)

.smart-header-enter-to,
.smart-header-leave-from
