...
async function register() {
  ...
  try {
    ...
    // AuthUtils session refresh
    await refreshSession()
    
    router.push('/dashboard')
  } catch (e: any) {
    error.value = e.data?.statusMessage || 'Kayıt olurken bir hata oluştu.'
  } finally {
    loading.value = false
  }
}
    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="register" class="auth-form">
        ...
        <div class="auth-footer">
          <p>Zaten hesabınız var mı? <NuxtLink to="/login">Giriş Yapın</NuxtLink></p>
        </div>
    </div>
  </div>
</template>
